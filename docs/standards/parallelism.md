...
Allow parallel execution only when it is explicit, bounded, and safe.
...
- `execution-contract.md` has locked the run scope
...
- independent template or documentation updates with a later consolidation pass
...
- verification, review, and finalization before fan-in
