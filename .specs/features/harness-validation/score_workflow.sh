...
# Unquoted heredoc so FEATURE_DIR_ABS is expanded by bash.
...
console.log('  phase_coverage     x 0.15 = ' + phase_score.toFixed(4) + ' x 0.15 = ' + (phase_score * 0.15).toFixed(4));
console.log('  evidence_quality   x 0.25 = ' + evidence_score.toFixed(4) + ' x 0.25 = ' + (evidence_score * 0.25).toFixed(4));
console.log('  --------------------------------------------------------');
